...
Полная спецификация — [`api/openapi.yaml`](../api/openapi.yaml) (OpenAPI 3.0.3). Её можно открыть в [Swagger Editor](https://editor.swagger.io/): вставьте содержимое файла, и слева появится интерактивная документация. Этот раздел объясняет принципы API и ключевые решения.
